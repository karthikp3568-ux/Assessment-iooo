        ...
        if (assessmentRepository.count() == 0) {
            ...
            List<Question> javaQuestions = List.of(
                    ...
                    Question.builder()
                            ...
                            .starterCode("import java.util.Scanner;\n\npublic class Solution {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        int n = sc.nextInt();\n        // Write your code here to find and print the maximum element\n        \n    }\n}")
                            .sampleInput("5\n3 7 2 9 5")
                            .sampleOutput("9")
                            .testCases("[{\"input\": \"5\\n3 7 2 9 5\", \"expectedOutput\": \"9\"}, {\"input\": \"3\\n1 2 3\", \"expectedOutput\": \"3\"}]")
                    ...
                    Question.builder()
                            ...
                            .programmingLanguage("java")
                            .starterCode("import java.util.Scanner;\n\npublic class Solution {\n    public static void main(String[] args) {\n        Scanner sc = new Scanner(System.in);\n        String str = sc.nextLine();\n        // Write your code here to check palindrome and print true or false\n        \n    }\n}")
                            .sampleInput("radar")
                            .sampleOutput("true")
                            .testCases("[{\"input\": \"radar\", \"expectedOutput\": \"true\"}, {\"input\": \"hello\", \"expectedOutput\": \"false\"}]")
